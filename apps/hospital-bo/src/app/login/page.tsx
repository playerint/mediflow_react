    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 13, color: 'var(--s400)', marginTop: 4 }}>병원 관리자 로그인</div>
        </div>
        ...
        <div style={{
          ...
          <div>올래성형외과: h1@mediflow.io / hospital1234</div>
          <div>강남뷰티클리닉: h2@mediflow.io / hospital1234</div>
        </div>
      </div>
    </div>
  )
